...
namespace MusikPlayer
{
    ...
    {
        public string Version_Title { get { return $"Musicplayer Version: {VERSION_INFO} (TEST)"; } }
        ...
        private static readonly string VERSION_INFO = Assembly.GetExecutingAssembly().GetName().Version.ToString();
