...
namespace MusikPlayer.FileManager
{
    public class JsonDirector : FilePathBase
    {
        ...
        //TODO: timespan wird nicht richtig geladen
        private List<SoundItem> LoadSoundsFromJson(string filePath)
        {
        ...
        //TODO: timespan wird nicht richtig geladen
        private List<PlayListListItem> LoadPlayListFromJson(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
            {
